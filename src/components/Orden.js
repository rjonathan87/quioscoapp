...
const Orden = ({orden}) => {
  ...
  return (
    <div className="border p-10 space-y-15">
      <h3 className="text-2xl font-bold">Orden: {id}</h3>
      <p className="text-lg font-bold">Cliente: {nombre}</p>
      <>
        {pedido.map(platillo => (
          <div key={platillo.id} className="py-3 flex border-b last-of-type:border0 items-center">
            <div className="w-32">
              <Image 
                width={400}
                height={500}
      ...
      <div className="md:flex md:items center md:justify-between by-10">
